    ...
    <div class="tilmelding">
        ...
        <form action="" method="post" class="tilmeldingboks">
            <table>
                ...
                <tr>
                    <td>First name:</td>
                    <td><input type="text" name="fornavn" placeholder="Enter first name" required/></td>
                </tr>
                <tr>
                    <td>Last name:</td>
                    <td><input type="text" name="efternavn" placeholder="Enter last name" required/></td>
                </tr>
                <tr>
                    <td></td>
                    <td><input type="submit" name="submit" value="Tilmeld dig"></td>
                </tr>
            </table>
        </form>
    </div>
